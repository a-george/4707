...
transformInsertStmt(ParseState *pstate, InsertStmt *stmt)
{
     ...
     *
     * The grammar allows attaching ORDER BY, LIMIT, FOR UPDATE, IGNORE, or WITH to a
...
transformSelectStmt(ParseState *pstate, SelectStmt *stmt)
{
    ...
    qry->limitCount = transformLimitClause(pstate, stmt->limitCount,
                                           "LIMIT");
    /* transform IGNORE */
    qry->ignoreClause = transformLimitClause(pstate, stmt->ignoreClause,
                                             "IGNORE");
...
transformValuesClause(ParseState *pstate, SelectStmt *stmt)
{
    ...
    /*
     * The grammar allows attaching ORDER BY, LIMIT, IGNORE, and FOR UPDATE to a
     * VALUES, so cope.
     */
    qry->sortClause = transformSortClause(pstate,
                                          stmt->sortClause,
    ...
    /* Allows an IGNORE statement to be attached */
    qry->ignoreClause = transformLimitClause(pstate, stmt->ignoreClause,
                                             "IGNORE");
...
transformSetOperationStmt(ParseState *pstate, SelectStmt *stmt)
{
    ...
    *sv_varnamespace;
    ...
    ignoreClause = stmt->ignoreClause;
    ...
    qry->limitCount = transformLimitClause(pstate, limitCount,
                                           "LIMIT");
    qry->ignoreClause = transformLimitClause(pstate, ignoreClause,
                                             "IGNORE");
